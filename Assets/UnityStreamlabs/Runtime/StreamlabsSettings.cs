...
{
    /// <summary>
    /// Project-specific Streamlabs settings resource.
    /// </summary>
    public class StreamlabsSettings : ScriptableObject
    {
        ...
        /// <summary>
        /// Streamlabs API application credentials used to authorize requests via loopback and redirect schemes.
        /// </summary>
        public GenericClientCredentials GenericClientCredentials => genericClientCredentials;
        /// <summary>
        /// Scopes of access to the user's Streamlabs the app will request.
        ...
        public bool EmitDebugMessages => emitDebugMessages;
        ...
        [SerializeField] private string accessTokenPrefsKey = "StreamlabsAccessToken";
        [SerializeField] private string refreshTokenPrefsKey = "StreamlabsRefreshToken";
        [SerializeField] private bool emitDebugMessages = false;
        ...
        public static StreamlabsSettings LoadFromResources (bool silent = false)
        {
            var settings = Resources.Load<StreamlabsSettings>("StreamlabsSettings");

            if (!settings && !silent)
            {
                Debug.LogError("UnityStreamlabs: Settings file not found. " +
                    "Use 'Edit > Project Settings > Streamlabs Settings' to create a new one.");
            }
