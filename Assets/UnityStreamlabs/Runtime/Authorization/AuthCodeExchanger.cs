...
namespace UnityStreamlabs
{
    ...
    public class AuthCodeExchanger
    {
        ...
        public AuthCodeExchanger (StreamlabsSettings StreamlabsSettings, IClientCredentials clientCredentials)
        {
        ...
        public void ExchangeAuthCode (string authorizationCode, string codeVerifier, string redirectUri)
        {
            ...
            exchangeRequest.SetRequestHeader("Content-Type", StreamlabsSettings.RequestContentType);
        ...
        private static bool CheckRequestErrors (UnityWebRequest request)
        {
            if (request == null)
            {
                Debug.LogError("UnityStreamlabs: Exchange auth code request failed. Request object is null.");
                return true;
            }
            ...
            if (isError) Debug.LogError("UnityStreamlabs: Exchange auth code request failed." + errorDescription);
            return isError;
        }
    }
}
