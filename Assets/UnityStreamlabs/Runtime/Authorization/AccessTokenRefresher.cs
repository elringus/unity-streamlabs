...
namespace UnityStreamlabs
{
    ...
    public class AccessTokenRefresher
    {
        ...
        public void RefreshAccessToken (string refreshToken)
        {
            ...
            refreshRequest.SetRequestHeader("Content-Type", StreamlabsSettings.RequestContentType);
        ...
        private static bool CheckRequestErrors (UnityWebRequest request)
        {
            if (request == null)
            {
                Debug.LogError("UnityStreamlabs: Refresh token request failed. Request object is null.");
                return true;
            }
            ...
            if (isError) Debug.LogError("UnityStreamlabs: Refresh token code request failed." + errorDescription);
            return isError;
        }
    }
}
